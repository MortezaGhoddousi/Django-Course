        ...
        <Fragment>
            ...
            <section className="adg">
                ...
                <ul>
                    ...
                    <li>
                        <p>
                            بستری برای ملاقات با مدیران شرکت ها در نمایشگاه کار
                        </p>
                        <i className="bx bx-chevron-down"></i>
                    </li>
                    <li>
                    ...
                    <li>
                        <p>
                            قوی‌ترین شبکه‌های اجتماعی در بین سایت‌های کاریابی
                            ایرانی
                        </p>
                        <i className="bx bx-chevron-down"></i>
                    </li>
            ...
            <section className="register">
                ...
                <p>
                    از آخرین فرصت‌های شغلی معتبرترین شرکت‌های ایران باخبر شده و
                    در آنها استخدام شوید.
                </p>
